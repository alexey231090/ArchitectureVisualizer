...
- Полностью удалены устаревшие вкладки и функционал Tables, Structure, Script Details.
- Реализована новая вкладка **Debug Logs**:
...
- Вкладка Event Tracking и основной функционал плагина не затронуты.

## Следующие шаги

- Дальнейшее развитие Debug Logs (например, массовые действия, фильтрация, экспорт).
- Оптимизация производительности при большом количестве скриптов.
- Улучшение UX и документации.
