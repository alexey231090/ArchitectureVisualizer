...
## Важно!
> Устаревшие функции (Tables, Script Details) не развиваются и будут удалены в будущем. Не удалять без отдельной команды: сначала закомментировать и проверить работоспособность, затем только удалять закаментированное!
